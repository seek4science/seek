...
seek_custom_metadata_type = SampleAttributeType.find_or_initialize_by(title:'Linked Custom Metadata')
seek_custom_metadata_type.update(base_type: Seek::Samples::BaseType::SEEK_CUSTOM_METADATA)
