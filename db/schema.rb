...
ActiveRecord::Schema.define(version: 20180815104232) do
  ...
  add_index "activity_logs", ["action"], name: "act_logs_action_index", length: {"action"=>191}, using: :btree
  add_index "activity_logs", ["activity_loggable_type", "activity_loggable_id"], name: "act_logs_act_loggable_index", length: {"activity_loggable_type"=>191, "activity_loggable_id"=>nil}, using: :btree
  add_index "activity_logs", ["culprit_type", "culprit_id"], name: "act_logs_culprit_index", length: {"culprit_type"=>191, "culprit_id"=>nil}, using: :btree
  add_index "activity_logs", ["format"], name: "act_logs_format_index", length: {"format"=>191}, using: :btree
  add_index "activity_logs", ["referenced_type", "referenced_id"], name: "act_logs_referenced_index", length: {"referenced_type"=>191, "referenced_id"=>nil}, using: :btree
  ...
  add_index "annotation_attributes", ["name"], name: "index_annotation_attributes_on_name", length: {"name"=>191}, using: :btree
  ...
  add_index "annotations", ["source_type", "source_id"], name: "index_annotations_on_source_type_and_source_id", length: {"source_type"=>191, "source_id"=>nil}, using: :btree
  ...
  add_index "assay_assets", ["asset_id", "asset_type"], name: "index_assay_assets_on_asset_id_and_asset_type", length: {"asset_id"=>nil, "asset_type"=>191}, using: :btree
  ...
  add_index "assets_creators", ["asset_id", "asset_type"], name: "index_assets_creators_on_asset_id_and_asset_type", length: {"asset_id"=>nil, "asset_type"=>191}, using: :btree
  ...
  add_index "avatars", ["owner_type", "owner_id"], name: "index_avatars_on_owner_type_and_owner_id", length: {"owner_type"=>191, "owner_id"=>nil}, using: :btree
  ...
  add_index "content_blobs", ["asset_id", "asset_type"], name: "index_content_blobs_on_asset_id_and_asset_type", length: {"asset_id"=>nil, "asset_type"=>191}, using: :btree
  ...
  add_index "message_logs", ["resource_type", "resource_id"], name: "index_message_logs_on_resource_type_and_resource_id", length: {"resource_type"=>191, "resource_id"=>nil}, using: :btree
  ...
  add_index "resource_publish_logs", ["resource_type", "resource_id"], name: "index_resource_publish_logs_on_resource_type_and_resource_id", length: {"resource_type"=>191, "resource_id"=>nil}, using: :btree
  ...
  add_index "sample_resource_links", ["resource_id", "resource_type"], name: "index_sample_resource_links_on_resource_id_and_resource_type", length: {"resource_id"=>nil, "resource_type"=>191}, using: :btree
  ...
  add_index "synonyms", ["substance_id", "substance_type"], name: "index_synonyms_on_substance_id_and_substance_type", length: {"substance_id"=>nil, "substance_type"=>191}, using: :btree
