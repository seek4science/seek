function fadeRow(id) {
    try {
        ...
        var gene_element_id = 'strain_gene_'.concat(id.toString()).concat('_title')
        $(gene_element_id).remove()
        var modification_element_id = 'strain_modification_'.concat(id.toString()).concat('_title')
...
function addRow(tableID) {
    ...
    element1.type = "text";
    element1.size = 10;
    element1.name = "strain[gene_".concat(rowCount.toString()).concat("][title]")
    element1.id = "strain_gene_".concat(rowCount.toString()).concat("_title")
    ...
    element2.type = "text";
    element2.size = 10;
    element2.name = "strain[modification_".concat(rowCount.toString()).concat("][title]")
    element2.id = "strain_modification_".concat(rowCount.toString()).concat("_title")
