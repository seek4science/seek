    ...
    module Relationships
      ...
      module Associations
        ...
        included do
          ...
          has_many :assets_links, dependent: :destroy, as: :asset, foreign_key: :asset_id
          has_many :discussion_links, -> { where(AssetsLink.discussion.where_values_hash) }, class_name: 'AssetsLink', as: :asset, dependent: :destroy, inverse_of: :asset
