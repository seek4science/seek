module Seek
  module Samples
    ...
    module BaseType
      ALL_TYPES = %w(Integer Float String DateTime Date Text Boolean SeekStrain SeekSample SeekSampleMulti CV SeekDataFile CVList LinkedExtendedMetadata LinkedExtendedMetadataMulti SeekSop)
