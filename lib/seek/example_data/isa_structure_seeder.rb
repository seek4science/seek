...
module Seek
  module ExampleData
    class IsaStructureSeeder
      ...
      def seed
        puts "Seeding ISA structure..."
        
        # Investigation
        investigation = Investigation.new(
          title: 'Central Carbon Metabolism of Sulfolobus solfataricus',
        ...
        # Experimental assay
        exp_assay = Assay.new(
          title: 'Reconstituted system reference state',
        ...
        exp_assay.save
        puts "Seeded 1 #{exp_assay.assay_class.long_key.downcase}."
        
        # Modelling assay
        model_assay = Assay.new(
          title: 'Model reconstituted system',
