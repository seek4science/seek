  ...
  module JSONMetadata
    module Attribute
      ...
      included do
        ...
        delegate :controlled_vocab?, :seek_cv_list?, :seek_sample?, :seek_sample_multi?, :seek_strain?, :seek_resource?, :seek_custom_metadata?, to: :sample_attribute_type, allow_nil: true
      end
