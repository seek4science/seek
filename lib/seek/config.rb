module Seek
  ...
  class Config
    ...
    settings = [:home_description, :home_feeds_cache_timeout, :public_seek_enabled, :events_enabled, :bioportal_api_key, :jerm_enabled, :email_enabled, :no_reply, :jws_enabled,
      ...
      :admin_impersonation_enabled, :auth_lookup_enabled, :strategic_eager_loading,:sample_parent_term,:specimen_culture_starting_date,:sample_age,:specimen_creators, :sample_parser_enabled,:project_browser_enabled, :experimental_features_enabled, :external_search_enabled]
