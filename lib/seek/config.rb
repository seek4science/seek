module Seek
  ...
  class Config
    ...
    settings = [:home_description, :public_seek_enabled, :events_enabled, :bioportal_api_key, :jerm_enabled, :email_enabled, :no_reply, :jws_enabled,
      ...
      :project_news_enabled,:project_news_feed_urls,:community_news_enabled,:community_news_feed_urls,:is_virtualliver,:presentations_enabled, :sabiork_ws_base_url, :admin_impersonation_enabled]
