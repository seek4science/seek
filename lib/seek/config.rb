...
module Seek
  ...
  class Config
    ...
    settings = [:home_description, :home_feeds_cache_timeout, :public_seek_enabled, :bioportal_api_key, :no_reply,
      ...
      :header_tagline_text_enabled,:header_home_logo_image,:related_items_limit,:css_appended, :css_prepended, :javascript_appended,:javascript_prepended,:main_layout,:profile_select_by_default,:support_email_address]
