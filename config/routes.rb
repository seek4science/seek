ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :models, 
    :member => { :download => :get, :execute=>:post, :request_resource=>:post,:preview_publish=>:get,:publish=>[:post, :get], :builder=>:get,:visualise=>:get, :export_as_xgmml=>:post,:submit_to_jws=>:post, :submit_to_sycamore=>:get, :simulate=>:post, :update_annotations_ajax=>:post },
