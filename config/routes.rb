ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :presentations,
                :member => {:download=>:get,:new_version=>:post,:publish=>[:post,:get],:publish_related_items=>:post,
                            :check_related_items=>:post,:check_gatekeeper_required=>:post,
  ...
  map.resources :data_files,
                ...
                :member => {:download=>:get,:plot=>:get, :data => :get,:publish=>[:post,:get],:publish_related_items=>:post,
                            :check_related_items=>:post,:check_gatekeeper_required=>:post,
  ...
  map.resources :models, 
    :member => {:download => :get, :matching_data=>:get, :execute=>:post, :request_resource=>:post,:publish=>[:post,:get],:publish_related_items=>:post,
                :check_related_items=>:post,:check_gatekeeper_required=>:post,
                :approve_or_reject_publish=>:get, :gatekeeper_decide=>:post,
  ...
  map.resources :people,
                :member=>{:admin=>:get,:batch_publishing_preview=>:get,:publish=>[:post,:get],:publish_related_items=>:post,
                          :check_related_items=>:post,:check_gatekeeper_required=>:post},
  ...
  map.resources :sops,
                :member => {:download=>:get,:new_version=>:post,
                            :publish=>[:post,:get],:publish_related_items=>:post,
                            :check_related_items=>:post,:check_gatekeeper_required=>:post,
                            :approve_or_reject_publish=>:get,:gatekeeper_decide=>:post,
