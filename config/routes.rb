SEEK::Application.routes.draw do
  ...
  resources :projects, concerns: [:has_avatar] do
    ...
    resources :programmes, :people, :institutions, :assays, :studies, :investigations, :models, :sops, :workflows, :data_files, :presentations,
              :publications, :events, :sample_types, :samples, :specimens, :strains, :search, :organisms, :human_diseases, :documents, :file_templates, :placeholders, :collections, :templates, :services, only: [:index]
  ...
  resources :studies, concerns: [:publishable, :has_snapshots, :isa] do
    ...
    resources :people, :programmes, :projects, :sample_types, :assays, :investigations, :models, :sops, :workflows, :data_files, :publications, :documents, :services, only: [:index]
  end
  ...
  resources :assays, concerns: [:publishable, :has_snapshots, :isa] do
    ...
    resources :people, :programmes, :projects, :investigations, :sample_types, :samples, :studies, :models, :sops, :workflows, :data_files, :publications, :documents, :strains, :organisms, :human_diseases, :placeholders, :services, only: [:index]
  end
