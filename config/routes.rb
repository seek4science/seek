ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :data_files, :collection=>{:test_asset_url=>:post},:member => {:download => :get, :data => :get,:preview_publish=>:get, :request_resource=>:post, :update_tags_ajax=>:post},:new=>{:upload_for_tool => :post}  do |data_file|
