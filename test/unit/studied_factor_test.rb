...
class StudiedFactorTest < ActiveSupport::TestCase
  fixtures :all
  test 'should create FS with the concentration of the substance' do
    ...
    assert fs.save, "should create the new factor studied with the concentration of the substance "
  end
