...
class OntologySynchronizationTest < ActiveSupport::TestCase
  ...
  test 'suggested assay types found' do
    ...
    with_config_value :assay_type_ontology_file, "file:#{Rails.root}/test/fixtures/files/JERM-sync-test.rdf" do
      ...
      assert_equal 'http://jermontology.org/ontology/JERMOntology#Amplification', assay.assay_type_uri
  ...
  test 'suggested technology types found' do
    ...
    assert_equal 'http://jermontology.org/ontology/JERMOntology#FRAP', assay.technology_type_uri
    with_config_value :technology_type_ontology_file, "file:#{Rails.root}/test/fixtures/files/JERM-sync-test.rdf" do
      ...
      assert_equal 'http://jermontology.org/ontology/JERMOntology#FACS', assay.technology_type_uri
  ...
  test 'reverts to default uri if removed' do
    ...
    assay.reload
    assert_equal 'http://jermontology.org/ontology/JERMOntology#Experimental_assay_type', assay.assay_type_uri
    assert_equal 'http://jermontology.org/ontology/JERMOntology#Technology_type', assay.technology_type_uri
  end
  ...
  test 'ontology uri for matching suggested type changes assay class so suggested type remains with label updated' do
    ...
    assert_equal 'http://jermontology.org/ontology/JERMOntology#Translation', assay.assay_type_uri
  end
end
