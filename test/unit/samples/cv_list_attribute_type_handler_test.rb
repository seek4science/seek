...
class CVListAttributeTypeHandlerTest < ActiveSupport::TestCase
  ...
  test 'test value' do
    ...
    handler = Seek::Samples::AttributeTypeHandlers::CVListAttributeHandler.new(attr)
  ...
  test 'exception thrown for missing controlled vocab' do
    ...
    handler = Seek::Samples::AttributeTypeHandlers::CVListAttributeHandler.new(attr)
    assert_raises(Seek::Samples::AttributeTypeHandlers::CVListAttributeHandler::MissingControlledVocabularyException) do
