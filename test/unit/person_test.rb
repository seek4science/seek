...
class PersonTest < ActiveSupport::TestCase
  ...
  test 'add to project and institution' do
    ...
    assert_iuncludes p1.projects, proj1
    assert_equal 1, p1.institutions.count
    assert_iuncludes p1.institutions, inst1
    ...
    assert_iuncludes p2.projects, proj1
    assert_equal 1, p2.institutions.count
    assert_iuncludes p2.institutions, inst1
    ...
    assert_iuncludes p1.projects, proj2
    assert_equal 2, p1.institutions.count
    assert_iuncludes p1.institutions, inst2
