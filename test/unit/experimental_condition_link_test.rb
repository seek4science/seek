...
class ExperimentalConditionLinkTest < ActiveSupport::TestCase
  ...
  test "should create a experimental_condition_link" do
    experimental_condition_link = ExperimentalCondition.new(:substance => compounds(:glucose), :experimental_condition => experimental_conditions(:experimental_condition_concentration_glucose))
  ...
  test "should not create experimental_condition_link without substance or experimental_condition" do
    experimental_condition_link = ExperimentalConditionLink.new(:substance => compounds(:glucose))
    assert !experimental_condition_link.save
