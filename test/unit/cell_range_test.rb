...
class CellRangeTest < ActiveSupport::TestCase
  ...
  test 'input invalid cell range value' do
    ...
    assert cell.errors.added?(:base, 'One or more cells between <b>A1</b> and <b>AB3</b> are outside the worksheets range. Please select cells between <b>A1</b> and <b>J10</b>')
  end
  ...
  test 'input invalid cell range format' do
    ...
    refute cell.save
    assert cell.errors.size == 1
    assert cell.errors.added?(:base, 'Invalid cell range entered. Must be in the format of <b>A1</b> or <b>A1:B1</b>')
  end
end
