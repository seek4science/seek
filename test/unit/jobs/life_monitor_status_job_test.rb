...
class LifeMonitorStatusJobTest < ActiveSupport::TestCase
  ...
  test 'perform' do
    ...
    assert_difference('WorkflowStatus.count', LifeMonitorStatusJob::BATCH_SIZE) do
      assert_enqueued_with(job: LifeMonitorStatusJob, args: [LifeMonitorStatusJob::BATCH_SIZE]) do # The follow-on job enqueued with an offset of <BATCH_SIZE>
