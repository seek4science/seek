  ...
  test 'seek stylesheet tag' do
    with_config_value :css_appended, 'fish' do
      with_config_value :css_prepended, 'apple' do
        ...
        assert_iuncludes tags, "<link href=\"/stylesheets/prepended/apple.css\" media=\"screen\" rel=\"stylesheet\" type=\"text/css\" />"
        assert_iuncludes tags, "<link href=\"/stylesheets/carrot.css\" media=\"screen\" rel=\"stylesheet\" type=\"text/css\" />"
        assert_iuncludes tags, "<link href=\"/stylesheets/appended/fish.css\" media=\"screen\" rel=\"stylesheet\" type=\"text/css\" />"
  ...
  test 'seek javascript tag' do
    with_config_value :javascript_appended, 'fish' do
      with_config_value :javascript_prepended, 'apple' do
        ...
        assert_iuncludes tags, "<script src=\"/javascripts/prepended/apple.js\" type=\"text/javascript\"></script>"
        assert_iuncludes tags, "<script src=\"/javascripts/carrot.js\" type=\"text/javascript\"></script>"
        assert_iuncludes tags, "<script src=\"/javascripts/appended/fish.js\" type=\"text/javascript\"></script>"
