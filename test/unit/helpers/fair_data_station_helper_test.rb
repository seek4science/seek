...
class FairDataStationHelperTest < ActionView::TestCase
  ...
  test 'fair_data_station_imports_to_show' do
    ...
    FactoryBot.create(:fair_data_station_upload, project: project, contributor: contributor, show_status: false).import_task.update_attribute(:status, Task::STATUS_QUEUED)
    ...
    other_person.save!
    other_person.reload
    FactoryBot.create(:fair_data_station_upload, project: project, contributor: other_person).import_task.update_attribute(:status, Task::STATUS_QUEUED)
    ...
    FactoryBot.create(:fair_data_station_upload, project: project, contributor: contributor).import_task.update_attribute(:status, Task::STATUS_CANCELLED)
