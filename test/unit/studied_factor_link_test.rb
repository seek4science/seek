...
class StudiedFactorLinkTest < ActiveSupport::TestCase
  ...
  test "should create a studied_factor link" do
    studied_factor_link = StudiedFactorLink.new(:substance => compounds(:glucose), :studied_factor => studied_factors(:studied_factor_concentration_glucose))
    assert studied_factor_link.save!
  end

  test "should not create studied_factor link without substance or studied_factor" do
    studied_factor_link = StudiedFactorLink.new(:substance => compounds(:glucose))
    assert !studied_factor_link.save
