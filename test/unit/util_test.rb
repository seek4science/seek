...
class UtilTest < ActiveSupport::TestCase
  ...
  test 'authorized types' do
    expected = [Assay, Collection, DataFile, Document, Event, Investigation, Model, Node, Presentation, Publication, Sample, Sop, Strain, Study, Workflow, Template].map(&:name).sort
