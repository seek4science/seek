    ...
    expected = { '@context' => Seek::BioSchema::Serializer::SCHEMA_ORG,
                 ...
                 'input' => [
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-inputs-#main/max-steps',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/max-steps' },
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-inputs-#main/reverse',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/reverse' },
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-inputs-#main/rulesfile',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/rulesfile' },
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-inputs-#main/sinkfile',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/sinkfile' },
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-inputs-#main/sourcefile',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/sourcefile' }
                 ],
                 'output' => [
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-outputs-#main/compounds',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/compounds' },
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-outputs-#main/reactions',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/reactions' },
                   { '@type' => 'FormalParameter',
                     '@id' => '#this_workflow-outputs-#main/sinks',
                     'dct:conformsTo' => Seek::BioSchema::ResourceDecorators::Workflow::FORMALPARAMETER_PROFILE,
                     'name' => '#main/sinks' }
                 ] }
