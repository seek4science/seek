  ...
  factory(:max_data_file, class: DataFile) do
    ...
    after(:create) do |data_file|
      ...
      if data_file.placeholder.blank?
        data_file.placeholder = FactoryBot.create(:public_placeholder, projects: data_file.projects)
      end

      if data_file.file_template.blank?
        data_file.file_template = FactoryBot.create(:public_file_template, projects: data_file.projects)
      end
