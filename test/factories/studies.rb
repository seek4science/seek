FactoryBot.define do
  ...
  factory(:isa_json_compliant_study, parent: :study) do
    ...
    after(:build) do |study|
      ...
      source_st = FactoryBot.create(:isa_source_sample_type, contributor: study.contributor)
      sample_collection_st = FactoryBot.create(:isa_sample_collection_sample_type, contributor: study.contributor, linked_sample_type: source_st)
