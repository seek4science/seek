...
Factory.define(:patient_sample_type, parent: :sample_type) do |f|
  ...
  f.after_build do |type|
    ...
    type.sample_attributes << Factory.build(:sample_attribute, title: 'weight', sample_attribute_type: Factory(:weight_sample_attribute_type), unit: Unit.find_by_symbol('g'), required: false, sample_type: type)
