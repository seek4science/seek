...
class InvestigationsControllerTest < ActionController::TestCase
  ...
  test "should show svg item" do
    ...
    #wm assert_response :success    
    #wm assert @response.body.include?("Generated by Graphviz"), "SVG generation failed, please make you you have graphviz installed, and the 'dot' command is available"
  end
