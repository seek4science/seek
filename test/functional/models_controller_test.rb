...
class ModelsControllerTest < ActionController::TestCase
  ...
  test "should get new populated from params" do
    get :new, :model=>{:title=>"the title",:description=>"the description",:data_url=>"wibblebibble", :original_filename=>"afile.xml", :imported_source=>"BioModels",:imported_url=>"http://biomodels/model.xml"}
    assert_response :success
  ...
  test "should show model with import details" do
    m = Factory :cronwright_model,:policy=>Factory(:public_policy), :imported_source=>"Some place",:imported_url=>"http://somewhere/model.xml"
    assert_difference('ActivityLog.count') do
      get :show, :id => m
    end
