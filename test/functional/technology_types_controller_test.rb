...
class TechnologyTypesControllerTest < ActionController::TestCase
 ...
 test "hierarchy" do
  ...
  test "correct label passed with suggested technology type uri should render correctly" do
    ...
    assay = Factory :experimental_assay, :technology_type_uri => suggested_technology_type.uri, :technology_type_label => suggested_technology_type.label ,:policy => Factory(:public_policy)
  ...
  test "no label passed render the same page as long as the same suggested technology type uri is passed" do
    suggested_technology_type = Factory(:suggested_technology_type)
    assay = Factory :experimental_assay, :technology_type_uri => suggested_technology_type.uri, :technology_type_label => suggested_technology_type.label ,:policy => Factory(:public_policy)
    #without label
    get :show, :uri => assay.technology_type_uri
