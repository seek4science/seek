...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test 'should show notice message when an item is requested to be published' do
    ...
    assert_select '#preview_permissions div.alert', text: "An email will be sent to the asset gatekeepers of the #{I18n.t('project').pluralize} associated with this #{I18n.t('sop')} to ask for publishing approval. This #{I18n.t('sop')} will not be published until one of the asset gatekeepers has granted approval.", count: 1
  end
  ...
  test 'should not show notice message when an item can be published right away' do
    ...
    assert_select '#preview_permissions div.alert', text: "An email will be sent to the asset gatekeepers of the  #{I18n.t('project').pluralize} associated with this #{I18n.t('sop')} to ask for publishing approval. This #{I18n.t('sop')} will not be published until one of the asset gatekeepers has granted approval.", count: 0
  end
