module ResourceListItemHelper
  ...
  def list_item_title resource, title=nil, url=nil    
    ...
    case name
      when "DataFile","Model","Sop"
        image = image_tag(((name == "Model") ? "/images/crystal_project/32x32/apps/kwikdisk.png" : (file_type_icon_url(resource))), :style => "width: 24px; height: 24px; vertical-align: middle")
