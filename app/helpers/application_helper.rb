...
module ApplicationHelper  
  ...
  def user_creatable_classes
    ...
    @@creatable_model_classes.delete(Event) unless Seek::ApplicationConfiguration.get_events_enabled
  ...
  def page_title controller_name, action_name
    ...
    return "#{Seek::ApplicationConfiguration.get_application_title} "+name
  end
  ...
  def hide_contact_details?
    Seek::ApplicationConfiguration.get_hide_details_enabled
  end
