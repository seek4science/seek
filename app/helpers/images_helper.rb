...
module ImagesHelper
  ...
  def icon_filename_for_key(key)
    ...
    when "expand"
      "folds/unfold.png"
    when "pal"
      "famfamfam_silk/rosette.png"#"pal.png"
    when "admin"
      "famfamfam_silk/shield.png"#"admin.png"
    when "pdf_file"
    ...
    when "investigation_avatar"
      "crystal_project/32x32/apps/mydocuments.png"    
    when "study_avatar"
      "crystal_project/32x32/apps/package_editors.png"    
    when "assay_avatar"
      "misc_icons/flask3-32x32.png"
    when "model_avatar"
