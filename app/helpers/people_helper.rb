module PeopleHelper
  ...
  def pal_icon person
    person.is_pal? ? image("pal",:alt=>"Pal",:title=>tooltip_title_attrib("Official #{Seek::ApplicationConfiguration.dm_project_name} Pal"), :style=>"vertical-align: middle")  : ""
  end

  def admin_icon person
    person.is_admin? ? image("admin",:alt=>"Admin",:title=>tooltip_title_attrib("#{Seek::ApplicationConfiguration.dm_project_name} Administrator"), :style=>"vertical-align: middle") : ""
  end
