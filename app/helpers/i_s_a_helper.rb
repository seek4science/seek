...
module ISAHelper
  ...
  def cytoscape_elements root_item, generator_options
    begin
      hash = Seek::IsaGraphGenerator.new(root_item).generate(generator_options)
      elements = cytoscape_node_elements(hash[:nodes]) + cytoscape_edge_elements(hash[:edges])
      elements
    rescue Exception=>e
