...
class Template < ApplicationRecord
  ...
  validate :validate_no_attributes_with_empty_isa_tag, if: -> { errors.blank? && !template_attributes.empty? }
  validate :validate_isa_tags, if: -> { errors.blank? && !template_attributes.empty? }
