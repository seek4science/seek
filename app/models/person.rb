...
class Person < ActiveRecord::Base
  ...
  grouped_pagination :pages=>("A".."Z").to_a, :default_page => Seek::ApplicationConfiguration.get_default_page(self.name.underscore.pluralize)
  ...
  acts_as_solr(:fields => [ :first_name, :last_name,:expertise,:tools,:locations, :description ]) if Seek::ApplicationConfiguration.get_solr_enabled
