class Programme < ApplicationRecord
  ...
  %i[data_files documents models sops presentations events publications samples workflows collections file_templates placeholders human_diseases].each do |type|
