...
core_xlink(project).merge(is_root ? xml_root_attributes : {}),
  ...
  if (is_root)
    people_list_xml parent_xml, project.people
    institutions_list_xml parent_xml, project.institutions
    assets_list_xml parent_xml,project.assets,"assets",false,true
  end
