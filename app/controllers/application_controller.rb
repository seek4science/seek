...
class ApplicationController < ActionController::Base
  ...
  def find_and_auth
    begin
      ...
      action = 'publish' if ['update', 'edit', 'create'].include?action and object.authorization_supported? and try_block{params[:sharing][:sharing_scope].to_i} == Policy::EVERYONE
