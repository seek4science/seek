class ContentBlobsController < ApplicationController
  ...
  before_filter :find_and_auth_asset, :only=>[:get_pdf, :view_pdf_content]
  before_filter :find_and_auth_content_blob, :only=>[:get_pdf, :view_pdf_content]
  before_filter :set_asset_version, :only=>[:get_pdf]
