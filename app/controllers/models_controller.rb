...
class ModelsController < ApplicationController
  ...
  before_filter :find_display_asset, :only=>[:show,:download,:execute,:builder,:simulate,:submit_to_jws,:submit_to_sycamore,:matching_data_files,:visualise,:export_as_xgmml,:send_image]
